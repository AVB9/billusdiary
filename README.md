...
there are many types of widgets 

E: standalone
A: core app only

[MS]: if more than one state present 
[O]: if overlay is present at all 

S: single user
M: multi user


so wordle would be E[MS6][O8]M_wordle 

standalone app need to have there own independent database file 
